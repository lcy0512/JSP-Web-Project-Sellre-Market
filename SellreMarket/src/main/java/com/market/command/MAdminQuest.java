...
public class MAdminQuest implements MCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		 ...
		 */
		int total = new AdminQuestDao().getProductCnt();
		...
		ArrayList<AdminQuestDto> list = new AdminQuestDao().selectList(index_no);	// 클릭한 페이지의 리스트 조회
